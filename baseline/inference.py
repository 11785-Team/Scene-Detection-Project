...
def linearSearch(kld_list, top_K = 100):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--top_K', type=int, default=100, help='the number of scene change to detect')
    ...
    kld_list = Infer(Model, dataset, batch_size=64, latent_dim=opts.latent_dim)
        
    index_of_change = linearSearch(kld_list, top_K)        
